                    ...
                    <Grid container direction="column" spacing={5}>
                        ...
                        <Grid item xs={12}>
                            <Grid container spacing={2} direction="row" justifyContent="space-around" alignItems="flex-start">
                                <Grid item xs={8}>
                                    <ContentCard Opt={Contents.c1} />
                                </Grid>
                                <Grid item xs={8}>
                                    <ContentCard Opt={Contents.c2} />
                                </Grid>
                                <Grid item xs={8}>
                                    <ContentCard Opt={Contents.c3} />
                                </Grid>
                                <Grid item xs={8}>
                                    <ContentCard Opt={Contents.c4} />
                                </Grid>
                                <Grid item xs={8}>
                                    <ContentCard Opt={Contents.c5} />
                                </Grid>
                                <Grid item xs={8}>
                                    <ContentCard Opt={Contents.c6} />
                                </Grid>
                            </Grid>
                        </Grid>
                    </Grid>
