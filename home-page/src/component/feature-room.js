...
import { height } from '../../../../../../Lap_trinh_web/TU_HOc/payment_demo/node_modules/@mui/system';
  ...
  return (
    <Box sx={{ width: '90%' , position: "relative" , left: "50%", transform: "translateX(-50%)", }}>
      ...
      <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }} >
        <Grid item xs={4} height="100%" padding="0">
          <Item>
                ...
                <Typography height variant="body1" gutterBottom textAlign="left" color={textcolor} minHeight="35vh" maxHeight="70vh" paddingBottom="2vh">
        ...
        <Grid item xs={4}>
            <Item>
                ...
                <Typography variant="body1" gutterBottom textAlign="left" color={textcolor} minHeight="35vh" maxHeight="70vh" paddingBottom="2vh" >
